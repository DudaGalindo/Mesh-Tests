...
Point(1) = {0, 0, 0};
Point(2) = {length, 0, 0};
Point(3) = {length, gridsize, 0};
Point(4) = {0, gridsize, 0};
...
Point(2*numElements+i) = {gridsize*i, 0, gridsize};
Point(3*numElements+i) = {gridsize*i, gridsize, 0};
Point(4*numElements+i) = {gridsize*i,0,0};
Point(5*numElements+i) = {gridsize*i, gridsize, gridsize};
...
Curve Loop(numElements+1) = {7, 9, -11, -2};
Curve Loop(numElements+2) = {5, 9, 13, 17};
